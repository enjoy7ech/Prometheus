    ...
    <>
      <header id="nav" className="header">
        <div className="header-content flex items-center">
          ...
          <div className="ml-auto flex h-full items-center gap-4 md:gap-12">
            <a
              href="https://game.dongzx.lol"
              target="_blank"
              rel="noopener noreferrer"
              className="game-center-btn"
            >
              <svg className="game-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path fill="currentColor" d="M21,6H3C1.9,6,1,6.9,1,8v8c0,1.1,0.9,2,2,2h18c1.1,0,2-0.9,2-2V8C23,6.9,22.1,6,21,6z M11,13H8v3H6v-3H3v-2h3V8h2v3h3V13z M15.5,15c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S16.3,15,15.5,15z M19.5,12c-0.8,0-1.5-0.7-1.5-1.5 s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S20.3,12,19.5,12z"/>
              </svg>
            </a>
            <div className="where-to-go" onClick={onWhereToGo}>
