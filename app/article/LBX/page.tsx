    ...
    <ArticleLayout>
      ...
      <div className={styles.article}>
        <div className={styles.header}>
          <PhotoGallery album="lbx" onReady={() => galleryPromise.resolve()}></PhotoGallery>
        </div>
          ...
          <article className={styles.content}>
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/AOAtp/0/IMG_4471.JPG?sign=7ik5Ubvwd-ChSTfxWiwemk5v2iUiwM09r9rBAjcyD-k%3D%3A0',
                  bgPos: 'center',
                  position: '苏州-灵岩山',
                  title: '入山',
                  title2: '通往山野的第一步',
            ...
            <section>
              ...
              <div className="flow-root my-8">
                <SRImage
                  ...
                  photo={{
                    id: 2,
                    url: 'https://pan.dongzx.lol/api/v4/file/content/20BIo/0/IMG_4472.JPG?sign=OPAfA9_VjLdEolvg3en4Vv1ZXU6Ez2-6viiielQileY%3D%3A0',
                    bgPos: 'center',
                    position: '灵白线-中段',
                    title: '攀越',
                    title2: '指尖与岩石的摩擦',
              ...
              <SRImage
                ...
                photo={{
                  id: 3,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/aJZc3/0/IMG_4473.JPG?sign=FJ2bD0CxPDWcTW0pETDRnPHXGKmSt2sKObwxsInwoRo%3D%3A0',
                  bgPos: 'center',
                  position: '光影山道',
                  title: '侧影',
                  title2: '山脊上的起伏',
            ...
            <section>
              ...
              <div className="flow-root my-8">
                <SRImage
                  ...
                  photo={{
                    id: 4,
                    url: 'https://pan.dongzx.lol/api/v4/file/content/D9XUl/0/IMG_4474.JPG?sign=wRVVnp5g9glcOEIFJaWzp4Br9DaG1wNYgk9BNw-2fBU%3D%3A0',
                    bgPos: 'center',
                    position: '山脊暮色',
                    title: '微光',
                    title2: '夕阳下的最后坚持',
              ...
              <SRImage
                ...
                photo={{
                  id: 5,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/Kbafv/0/IMG_4475.JPG?sign=ViyHxWOp5NNdn7XzmgD201xr5xttLR2mypF-218Dyv8%3D%3A0',
                  bgPos: 'center',
                  position: '白马涧-终点',
                  title: '归处',
                  title2: '与自我的握手言和',
            ...
            <section>
              ...
              <video
                src="https://pan.dongzx.lol/api/v4/file/content/EjkHG/0/IMG_4476.MOV?sign=an9s_7gCVKUZohh5vhmFsyjW5WzZTFz9rHN2VXsZ4Iw%3D%3A0"
                controls
