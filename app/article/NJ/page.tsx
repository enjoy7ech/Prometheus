    ...
    <ArticleLayout>
      ...
      <div className={styles.article}>
        <div className={styles.header}>
          <PhotoGallery album="nj" onReady={() => galleryPromise.resolve()}></PhotoGallery>
        </div>
          ...
          <article className={styles.content}>
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/MbwHG/0/IMG_3516.jpg?sign=fJBqkAT0UJjkrVmVs9_lUhY17C3EEVVW0WSdp0biM0w%3D%3A0',
                  bgPos: 'center',
                  position: '南京-新街口',
                  title: '路口',
                  title2: '夜色把霓虹揉进人群',
            ...
            <section>
              ...
              <div className="flow-root my-8">
                <SRImage
                  ...
                  photo={{
                    id: 2,
                    url: 'https://pan.dongzx.lol/api/v4/file/content/1W1hz/0/IMG_3515.jpg?sign=jc82ysS8JWHykLkmysH-ELVn7PvO6n4yyCNUJQ0FTHM%3D%3A0',
                    bgPos: 'center',
                    position: '南京-新街口',
                    title: '巷口',
                    title2: '路灯下的橘色光晕',
            ...
            <section>
              ...
              <div className="flow-root my-8">
                <SRImage
                  ...
                  photo={{
                    id: 3,
                    url: 'https://pan.dongzx.lol/api/v4/file/content/nK8cq/0/IMG_3519.jpg?sign=ZjnH-rfcgx3zvHZaYgG0cyQfwRYjMVURDCKp44cI2CE%3D%3A0',
                    bgPos: 'center',
                    position: '南京-龙吟九品',
                    title: '龙吟九品',
                    title2: '巷弄里的重逢',
              ...
              <SRImage
                ...
                photo={{
                  id: 4,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/PypF0/0/IMG_3517.jpg?sign=PDe8Gad5-Lgx8dm6CsayYiJWG0fOMvAg7kI17yY37ME%3D%3A0',
                  bgPos: 'center',
                  position: '南京-日常',
                  title: '莫愁的态度',
                  title2: '把生活折叠成有温度的模样',
