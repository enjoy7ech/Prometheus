          ...
          <article className={styles.content}>
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/xwlhq/0/IMG_2994.JPG?sign=Ey0bS2bv3btPgK5O-cbqLTltvmh7Q-f6t3jv_tchKn8%3D%3A0',
                  bgPos: 'center',
                  position: '',
                  title: '',
                  title2: '',
            ...
            <section>
              ...
              <video
                ...
                controls
                playsInline
                src="https://pan.dongzx.lol/api/v4/file/content/Ml0sG/0/IMG_3001.MOV?sign=vH8HH48iXN6oWvrF1jjr2U8g7xSdi-GtP9NUjBhudpQ%3D%3A0"
              ></video>
              ...
              <div className="flex flex-col md:flex-row gap-4 my-8 items-start">
                <div className="flex-1">
                  <SRImage
                    ...
                    photo={{
                      id: 1,
                      url: 'https://pan.dongzx.lol/api/v4/file/content/9j1S6/0/IMG_3004.JPG?sign=jx1l-yQRTRSmQXH7Vumb3ddyp_LJCU4kIFuIb28zfkI=:0',
                      bgPos: 'center',
                      position: '',
                      title: 'MyGo!!!',
                      title2: '',
                ...
                <div className="flex-1">
                  <SRImage
                    ...
                    photo={{
                      id: 1,
                      url: 'https://pan.dongzx.lol/api/v4/file/content/VqpC9/0/IMG_3003.JPG?sign=BEfifVdbCsU6BF0ZIX7KTQjSS1EiIpmJ6F9v3sXzLqw=:0',
                      bgPos: 'center',
                      position: '',
                      title: '这个买的人还挺多',
                      title2: '',
              ...
              <div className="flex flex-col md:flex-row gap-4 my-8 items-start">
                <div className="flex-1">
                  <SRImage
                    ...
                    photo={{
                      id: 1,
                      url: 'https://pan.dongzx.lol/api/v4/file/content/1pOfz/0/IMG_3007.JPG?sign=dlS8cTJTQUKGsh3j0_lwcBUJNL4JKtshIu8R3lKDCfA=:0',
                      bgPos: 'center',
                      position: '',
                      title: 'Animate',
                      title2: '',
                ...
                <div className="flex-1">
                  <SRImage
                    ...
                    photo={{
                      id: 1,
                      url: 'https://pan.dongzx.lol/api/v4/file/content/03whl/0/IMG_3006.JPG?sign=jHzRirZFLQTPRHIZgxgQ3v7sC9GKlrfXii5f9MY-a6g=:0',
                      bgPos: 'center',
                      position: '',
                      title: 'Ave Mujica',
                      title2: '',
            ...
            <section>
              ...
              <div className="flex flex-col md:flex-row gap-6 my-10 items-center">
                <video
                  ...
                  controls
                  playsInline
                  src="https://pan.dongzx.lol/api/v4/file/content/NY1S9/0/IMG_3014.MOV?sign=POYhm69Ceefg-q-O8jTGjkvhGFI7ygyx7qAoOLS1iJI%3D%3A0"
                ></video>
                ...
                <SRImage
                  ...
                  photo={{
                    id: 1,
                    url: 'https://pan.dongzx.lol/api/v4/file/content/2PECo/0/IMG_3017.jpg?sign=kc19tliUBpyHr-zjhers6aqlb0kDxe2wjOF-uxXlJes=:0',
                    bgPos: 'center',
                    position: '',
                    title: 'SHOUT！',
                    title2: '',
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/DlkSl/0/IMG_3020.JPG?sign=vjNT5b6ufLIxtdzU_teaaBZKjUzq5jGlP49yTLyA90s=:0',
                  bgPos: 'center',
                  position: '',
              ...
              <video
                ...
                controls
                playsInline
                src="https://pan.dongzx.lol/api/v4/file/content/AMMHp/0/IMG_3190.MOV?sign=YE3l4C9i1pCGGDm85VMnZvBrES8410hV-7U_EXkHX0Q%3D%3A0"
              ></video>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/pqksD/0/IMG_3030.JPG?sign=95WKPQoEYJhynGXwe_t0bPnDz6uaZ4gCQW7YiUUH6iQ=:0',
                  bgPos: 'center',
                  position: '',
                  title: '素敵な夜をありがとう',
                  title2: '',
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/dJxfG/0/IMG_3044.JPG?sign=YZiz373Pv6UAH1wObUxEWSWsHDrb0fwaaHqgtvlTzAA=:0',
                  bgPos: 'center',
                  position: '',
                  title: 'か米村',
                  title2: '',
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/R0pTM/0/IMG_3104.jpg?sign=bUcFxB7N4zwYRXGtJupvRyZC9Cu73Yx1r6yvT2jAsq8%3D%3A0',
                  bgPos: 'center',
                  position: '',
                  title: '没错，是我干的',
                  title2: '',
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/oG6IK/0/IMG_3054.JPG?sign=Eh-kMdxVrAv_15I56kymunF-qE2BbFL-795fP9qP1jA=:0',
                  bgPos: 'center',
                  position: '',
                  title: '现场',
                  title2: '',
            ...
            <section>
              ...
              <SRImage
                ...
                photo={{
                  id: 1,
                  url: 'https://pan.dongzx.lol/api/v4/file/content/kK2iJ/0/IMG_3058.JPG?sign=RYS0rJ7dpigvAnSZIVfNEwFhkVlX27qRTx33y3yfPfg=:0',
                  bgPos: 'center',
                  position: '',
                  title: '返程',
                  title2: '',
